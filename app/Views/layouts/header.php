...
<head>
    ...
    <script>
        // Injeta o perfil do usuário globalmente no JS para travas no front-end
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="menuPrincipal">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <?php endif; ?>
                    <?php if (isset($_SESSION['usuario']['perfil']) && $_SESSION['usuario']['perfil'] === 'admin'): ?>
                        <li class="nav-item">
                            <a class="nav-link <?= $action === 'usuarios' ? 'active' : '' ?>" 
